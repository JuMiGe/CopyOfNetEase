...
public class AsyncHttpClient {
    ...
    private final Map<Object, List<RequestHandle>> mFragmentListMap ;
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        mFragmentListMap = Collections.synchronizedMap(new WeakHashMap<Object, List<RequestHandle>>());
     ...
     *
     * @param tag               the tag instance associated to the request.
     * @param mayInterruptIfRunning specifies if active requests should be cancelled along with
     *                              pending requests.
     */
    public void cancelRequests(final Object tag, final boolean mayInterruptIfRunning) {
        if (tag == null) {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                List<RequestHandle> requestList = mFragmentListMap.get(tag);
                if (requestList != null) {
                    for (RequestHandle requestHandle : requestList) {
                        requestHandle.cancel(mayInterruptIfRunning);
                    }
                    mFragmentListMap.remove(tag);
                }
            }
        };
    ...
    public void cancelAllRequests(boolean mayInterruptIfRunning) {
        for (List<RequestHandle> requestList : mFragmentListMap.values()) {
            if (requestList != null) {
                for (RequestHandle requestHandle : requestList) {
                    requestHandle.cancel(mayInterruptIfRunning);
                }
     ...
     *
     * @param tag             the tag which initiated the request.
     * @param url             the URL to send the request to.
     * @param responseHandler the response handler instance that should handle the response.
     * @return RequestHandle of future request process
     */
    public RequestHandle head(Object tag, String url, ResponseHandlerInterface responseHandler) {
        return head(tag, url, null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle head(Object tag, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, new HttpHead(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle head(Object tag, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Object tag, String url, ResponseHandlerInterface responseHandler) {
        return get(tag, url, null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Object tag, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Object tag, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Object tag, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpGet(URI.create(url).normalize()), entity), contentType, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Object tag , String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return post(tag, url, paramsToEntity(params, responseHandler), null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post( Object tag, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(getURI(url)), entity), contentType, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Object tag, String url, Header[] headers, RequestParams params, String contentType,
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Object tag, String url, Header[] headers, HttpEntity entity, String contentType,
                              ResponseHandlerInterface responseHandler) {
        HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPost(getURI(url)), entity);
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Object tag, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return put(tag, url, paramsToEntity(params, responseHandler), null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Object tag, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(getURI(url)), entity), contentType, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle put(Object tag, String url, Header[] headers, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(Object tag, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
        return patch(tag, url, paramsToEntity(params, responseHandler), null, responseHandler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(Object tag, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPatch(getURI(url)), entity), contentType, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle patch(Object tag, String url, Header[] headers, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Object tag , String url, ResponseHandlerInterface responseHandler) {
        final HttpDelete delete = new HttpDelete(getURI(url));
        return sendRequest(httpClient, httpContext, delete, null, responseHandler, tag);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Object tag, String url, Header[] headers, ResponseHandlerInterface responseHandler) {
        final HttpDelete delete = new HttpDelete(getURI(url));
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Object tag, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
        HttpDelete httpDelete = new HttpDelete(getUrlWithQueryString(isUrlEncodingEnabled, url, params));
        if (headers != null) httpDelete.setHeaders(headers);
        return sendRequest(httpClient, httpContext, httpDelete, null, responseHandler, tag);
    }

    /**
     * Perform a HTTP DELETE request and track the Android Context which initiated the request.
     *
     * @param tag         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param entity          a raw {@link org.apache.http.HttpEntity} to send with the request, for
     *                        example, use this to send string/json/xml payloads to a server by
     *                        passing a {@link org.apache.http.entity.StringEntity}.
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle delete(Object tag, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(URI.create(url).normalize()), entity), contentType, responseHandler, tag);
    }
     ...
     */
    protected AsyncHttpRequest newAsyncHttpRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Object tag) {
     ...
     * @param client          HttpClient to be used for request, can differ in single requests
     * @param contentType     MIME body type, for POST and PUT requests, may be null
     * @param tag             tag, to hold the reference of request
     * @param httpContext     HttpContext in which the request will be executed
     * @param responseHandler ResponseHandler or its subclass to put the response into
     * @param uriRequest      instance of HttpUriRequest, which means it must be of HttpDelete,
     *                        HttpPost, HttpGet, HttpPut, etc.
     * @return RequestHandle of future request process
     */
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Object tag) {
        if (uriRequest == null) {
        ...
        AsyncHttpRequest request = newAsyncHttpRequest(client, httpContext, uriRequest, contentType, responseHandler, tag);
        ...
        if (tag != null) {
            ...
            synchronized (mFragmentListMap) {
                requestList = mFragmentListMap.get(tag);
                if (requestList == null) {
                    requestList = Collections.synchronizedList(new LinkedList<RequestHandle>());
                    mFragmentListMap.put(tag, requestList);
                }
            }
